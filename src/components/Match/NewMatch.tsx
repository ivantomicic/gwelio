...
import { Plus, User as UserIcon, Target, Trophy, ChevronDown, X } from 'lucide-react';
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="relative">
        <div className="flex items-center space-x-3 mb-3">
          ...
          <h3 className="text-lg font-medium text-gray-900 dark:text-white">Select Opponent</h3>
        </div>
        ...
        <div className="relative">
          ...
          >
            <div className="flex items-center justify-between">
              <span className={selectedOpponent ? 'text-gray-900 dark:text-white' : 'text-gray-500 dark:text-gray-400'}>
                {selectedOpponent ? selectedOpponent.full_name : 'Select an opponent'}
              </span>
                ...
                {users.map(user => (
                  <button
                    ...
                    className={`w-full px-4 py-2 text-left hover:bg-gray-100 dark:hover:bg-gray-700 ${
                      opponent === user.id ? 'bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400' : 'text-gray-900 dark:text-white'
                    }`}
                  >
                    {user.full_name}
                  </button>
      ...
      {opponent && (
        <div className="relative">
          <div className="flex items-center space-x-3 mb-3">
            ...
            <h3 className="text-lg font-medium text-gray-900 dark:text-white">Enter Scores</h3>
          </div>
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4 mb-2">
              ...
              <div className="text-center text-sm font-medium text-gray-700 dark:text-gray-300">
                {selectedOpponent?.full_name}'s Score
              </div>
            </div>
              ...
              <div key={index} className="flex items-center space-x-3">
                ...
                <div className="flex-1 grid grid-cols-2 gap-4">
                  <input
                    ...
                    onChange={(e) => handleSetChange(index, 'player1', parseInt(e.target.value) || 0)}
                  ...
                  <input
                    ...
                    onChange={(e) => handleSetChange(index, 'player2', parseInt(e.target.value) || 0)}
                    className="w-full text-center rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400"
                    min="0"
                    max="99"
                  />
